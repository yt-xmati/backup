...
{
	public static var psychEngineVersion:String = '0.5.1'; //This is also (not) used for Discord RPC
	public static var portVersion:String = '2.5'; //This is also used for Discord RPC
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				if (optionShit[curSelected] == 'down')
				{
					CoolUtil.browserLoad('https://cdn.discordapp.com/attachments/912063529878716456/950388700997648384/crack_rat-1.mp4');
				}
				else
				{
					selectedSomethin = true;
