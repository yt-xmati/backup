...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['i br', 0.6], //From 50% to 59%
		['ratio', 0.69], //From 60% to 68%
		['funny', 0.7], //69%
		['ratio counter', 0.8], //From 70% to 79%
		['cool', 0.9], //From 80% to 89%
		['SICK TRICKS DAVE!', 1], //From 90% to 99%
		['i broke my phone!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
